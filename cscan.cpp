...
{   
	...
	{	
		...
		{
		    if(env[found][0]=='S' && env[found][1]=='y' && env[found][12]!=':')
			break;			
		}
			...
			if(strcmp(sign,"LITTLE17")==0)
			{
	            ...
	            while(1)
                {
                    ...
                    {  
					    ...
					    udata1=start+(strlen(dbsign))-udata1;
					    if( vp!=NULL && !access(vfile.ff_name,4) && udata1<vfile.ff_fsize )
					    {
					        udata1=start;
						    udata2=udata3;
